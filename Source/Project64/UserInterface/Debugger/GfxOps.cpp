...
void CGfxOps::op_gsDPSetOtherMode(CGfxParser* state, decoded_cmd_t* dc)
{
    ...
    {
        dc->params += stdstr(szPresetC1) + "|" + stdstr(szPresetC2) + ")";
    }
    else
    {
...
void CGfxOps::op_gsDPSetTile(CGfxParser* state, decoded_cmd_t* dc)
{
    ...
    dc->params = stdstr_f("/*fmt*/ %s, /*siz*/ %s, /*line*/ %d, /*tmem*/ 0x%03X, /*tile*/ %d, /*palette*/ %d, /*cmt*/ %d, /*maskt*/ %d, /*shiftt*/ %d, /*cms*/ %d, /*masks*/ %d, /*shifts*/ %d", fmtName, sizName,
